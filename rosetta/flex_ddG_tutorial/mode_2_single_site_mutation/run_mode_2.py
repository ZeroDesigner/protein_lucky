...
if use_multiprocessing:
    ...
    max_cpus = 30
 # We might want to not run on the full number of cores, as Rosetta take about 2 Gb of memory per instance
...
number_backrub_trials = 5 # Normally 35000
...
path_to_script = 'path_to/mode_2_single_site_mutation/ddG-backrub.xml'
