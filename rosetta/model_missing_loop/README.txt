...
1:creat the original_pdb,
model_1_miss.pdb is the loop_miss protein which you need to model
then run command ' score_jd2.static.linuxgccrelease -in:file:s original_pdb -renumber_pdb true -out:pdb -overwrite
'
OK,now you get the pdb_file --'original_pdb_0001.pdb '
